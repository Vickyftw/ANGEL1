    ...
    inline_help_dicts = [
        {
            ...
            "thumb_urL": "https://telegra.ph/file/f782720927381c6e26783.jpg",
            "keyboard": ".spb ",
        },
        {
            "title": "Account info on Angel",
            "description": "Look up a Telegram account in Miku database",
            "message_text": "Click the button below to look up a person in Angel database using their Telegram ID",
            "thumb_urL": "https://telegra.ph/file/b6b6d37ef00603df9bd99.jpg",
            "keyboard": ".info ",
        },
        {
            "title": "About",
            "description": "Know about Angel",
            "message_text": "Click the button below to get to know about Angel.",
            "thumb_urL": "https://telegra.ph/file/cec8b2f2df1128663a82c.jpg",
            "keyboard": ".about ",
        },
        {
            "title": "Help",
            ...
            "thumb_urL": "https://telegra.ph/file/f96f3bf68709212a96bba.jpg",
            "keyboard": ".help ",
        },
        {
            "title": "Anilist",
            ...
            "thumb_urL": "https://telegra.ph/file/21c0f66e65082384c761a.jpg",
            "keyboard": ".anilist ",
        },
        {
            "title": "Paste",
            ...
            "thumb_urL": "https://telegra.ph/file/f1912776dda151964fd53.jpg",
            "keyboard": ".paste ",
        },
    ]
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results = [
        InlineQueryResultArticle(
            id=str(uuid4()),
            thumb_url="https://telegra.ph/file/0270aa22d8c6ce8ad491e.jpg",
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results.append(
        InlineQueryResultPhoto(
            ...
            thumb_url="https://telegra.ph/file/1d48acf76800bc82e867a.jpg",
            photo_url="https://telegra.ph/file/c641abcfbd0169b7ed48e.jpg",
            caption=about_text,
...
def spb(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/8880f60b05b20984077e5.jpg",
...
def help(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results.append(
        InlineQueryResultPhoto(
            ...
            title="Help Commands",
            thumb_url="https://telegra.ph/file/f96f3bf68709212a96bba.jpg",
            photo_url="https://telegra.ph/file/f96f3bf68709212a96bba.jpg",
            caption=help_text,
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=kb,
        )
